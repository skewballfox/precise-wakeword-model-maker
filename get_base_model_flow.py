...
def split_data_and_get_best_model_flow(source_directory, random_split_directories, even_odd_split_directories, three_four_split_directories, root_model_name):
    ...
    best_training_set_accuracy_model = precise_modeling_operations_instance.pick_best_model()
...
def get_base_model_flow(source_directory, random_split_directories, even_odd_split_directories, three_four_split_directories, root_model_name, wakeword_model_name):
    ...
    selected_model_name, selected_model_results, experimental_average_accuracy_dialog = split_data_and_get_best_model_flow(source_directory, random_split_directories, even_odd_split_directories, three_four_split_directories, root_model_name)
    ...
    print(dialog_handler_instance.render_template("inform-original_best_base_model_results", selected_model_results=selected_model_results))
    print(f'Current base model with incremental training on your random audio recordings: {base_model_info}')
